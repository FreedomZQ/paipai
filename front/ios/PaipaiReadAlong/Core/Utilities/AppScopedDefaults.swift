...
enum AppDefaultKey {
    ...
    static let capturePermissionRequested = "capture.permission.requested"
    static let capturePermissionGranted = "capture.permission.granted"
    static let capturePermissionDenied = "capture.permission.denied"
    ...
    static let localCaptureQuotaDate = "quota.local.capture.date"
    static let localCaptureUsed = "quota.local.capture.used"
    static let localSpeechQuotaDate = "quota.local.speech.date"
    static let localSpeechUsed = "quota.local.speech.used"
