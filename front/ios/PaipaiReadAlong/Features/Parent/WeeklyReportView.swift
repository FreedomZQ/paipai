        ...
        return ReportSectionCard {
            VStack(alignment: .leading, spacing: 14) {
                ...
                LazyVGrid(columns: [GridItem(.adaptive(minimum: 155), spacing: 12)], spacing: 12) {
                    ...
                    statCard(title: reportText("拍照识字", "Photo OCR", ja: "写真OCR", ko: "사진 OCR", es: "OCR"), value: "\(localOcrCount(report))", unit: reportText("次", " times", ja: "回", ko: "회", es: " veces"), desc: reportText("设备端 OCR 使用合计", "On-device OCR total", ja: "端末内OCRの合計", ko: "기기 내 OCR 합계", es: "OCR local"), icon: "camera.fill")
                    statCard(title: reportText("语音朗读", "Read aloud", ja: "音声読み上げ", ko: "음성 낭독", es: "Lectura en voz alta"), value: "\(localTtsCount(report))", unit: reportText("次", " times", ja: "回", ko: "회", es: " veces"), desc: reportText("设备端语音播放合计", "On-device speech total", ja: "端末内音声の合計", ko: "기기 내 음성 합계", es: "Voz local"), icon: "speaker.wave.2.fill")
